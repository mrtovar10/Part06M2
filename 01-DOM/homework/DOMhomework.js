...
// Tu código acá:
document.querySelector('#createdBy').innerHTML = 'Aplicación creada por: Máximo Tovar'
...
function displayToDos() {
  ...
  let arreglodeNodos = buildToDos(toDoItems)
  arreglodeNodos.forEach(function (value){
...
function addToDo() {
  // Tu código acá:
  let hacer = new ToDo(document.querySelector('#toDoInput').value)
...
// Tu código acá:
let click = document.querySelector('#addButton').addEventListener('click',addToDo)
